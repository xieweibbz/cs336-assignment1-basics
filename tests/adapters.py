...
from cs336_basics.train_bpe import CopyBPETokenizer
...
def run_rmsnorm(
    ...
    """
    wei_rmsn = WeiRMSNorm(d_model, eps=eps)
    wei_rmsn.g = nn.Parameter(weights)
    return wei_rmsn(in_features)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return wei_softmax(in_features, dim)
